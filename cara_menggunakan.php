...
<html lang="zxx">
<head>
    <title>GASKEUN - Cara Menggunakan</title>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="navbar-nav header-ml">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active" href="cara_menggunakan.php">
                            Cara Menggunakan
                        </a>
                    </li>
                    <li class="nav-item active">
...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area">
            <h1 style="font-weight:400;margin-top:-10px;"><b>CARA</b> MENGGUNAKAN</h1>
            <p class="pPutih">Berikut adalah cara menggunakan<br><b>Aplikasi GASKEUN</b></p>
        </div>
    </div>
</div>
<!-- Sub Banner end -->
...
<div class="about-real-estate  content-area-5">
    <div class="container">
        <div class="main-title text-center">
            <h1 style="font-weight:400"><b>FOLLOW THIS</b> STEP</h1>
        </div>
        <div class="row">

            <div class="col-md-3 col-xs-12">
                <img src="img/tutor_1_2.png" alt="" class="img-fluid"><br><br>
                <h2 class="text-center">1</h2> 
                <p class="tJustify">
                    Pilih lokasi & film yang akan 
                    di rencakan untuk di lihat kemudian tekan tombol " GAS "
                    </p>
            </div><!-- end col -->

            <div class="col-md-3 col-xs-12">
                <img src="img/tutor_2.png" alt="" class="img-fluid"><br><br>
                <h1 class="text-center">2</h2> 
                <p class="tJustify">
            ...
            <div class="col-md-3 col-xs-12">
                <img src="img/tutor_3.png" alt="" class="img-fluid"><br><br>
                <h2 class="text-center">3</h2> 
                <p class="tJustify">
                Pilihlah jam sesuai dengan prediksi yang muncul.<br>
                <b style="font-size:13px;">( Prediksi bisa berubah kapan saja )</b></p>
            </div><!-- end col -->

            <div class="col-md-3 col-xs-12">
                <img src="img/tutor_4.png" alt="" class="img-fluid"><br><br>
                <h2 class="text-center">4</h2> 
                <p class="tJustify">
                Selamat berkeliling kota dan menikmati indahnya suasa bandung. <br><b>dan selamat menonton <i class="fa fa-heart" style="color:red;"></i></b>
                    </p>
            </div><!-- end col -->
